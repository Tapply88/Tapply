...
class DbService {
  ...
  static Future<void> _seedProductsIfEmpty() async {
    ...
    final seed = [
      Product(id: _uuid.v4(), name: 'Kunyit Asam', price: 12000, category: 'Jamu'),
      Product(id: _uuid.v4(), name: 'Beras Kencur', price: 12000, category: 'Jamu'),
      Product(id: _uuid.v4(), name: 'Temulawak', price: 13000, category: 'Jamu'),
      Product(id: _uuid.v4(), name: 'Sinom', price: 12000, category: 'Jamu'),
      Product(id: _uuid.v4(), name: 'Wedang Uwuh', price: 15000, category: 'Jamu'),
      Product(id: _uuid.v4(), name: 'Jahe Merah', price: 13000, category: 'Jamu'),
    ];
    for (final p in seed) {
  ...
  static Future<TransactionRecord> saveTransaction({
    ...
    if (memberId != null && status == 'paid') {
      ...
      if (member != null) {
        member.points += Member.pointsFromAmount(total);
        await member.save();
      }
    }
    return tx;
