...
SUPABASE_SERVICE_ROLE_KEY=isi-service-role-key-dari-supabase-settings-api
PORT=3000
SRVENVEOF

echo 'Selesai. Untuk app Flutter: flutter clean && flutter pub get && flutter run -d web-server --web-port 8080 --release'
echo 'Untuk server/: cd server && npm install (kalau belum) lalu npm start (perlu isi .env dulu)'
